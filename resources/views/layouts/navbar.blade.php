            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-content wmin-md-350">
                    ...
                    <div class="dropdown-content-footer bg-light">
                        ...
                        <div>
                            <a href="#" class="text-grey" data-popup="tooltip" title=""
                               data-original-title="Mark all as read"><i class="icon-radio-unchecked"></i></a>
                            <a href="#" class="text-grey ml-2" data-popup="tooltip" title=""
                               data-original-title="Bug tracker"><i class="icon-bug2"></i></a>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-350">
                    ...
                    <div class="dropdown-content-footer justify-content-center p-0">
                        <a href="#" class="bg-light text-grey w-100 py-2" data-popup="tooltip" title=""
                           data-original-title="Load more"><i class="icon-menu7 d-block top-0"></i></a>
                    </div>
                </div>
            </li>
